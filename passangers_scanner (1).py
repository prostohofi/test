...
for passenger in passengers:
    for item in passengers["ручная кладь"]:
        if item in banned_items:
                print(f"В ручной клади пассажира {passenger} обнаружен запрещенный предмет {item}. Пассажир не допущен к вылету.")
                break
        else:
            print(f"Пассажир {passenger} допущен к вылету.")   # пассажир не допущен